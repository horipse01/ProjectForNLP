...
// import { toPortalMessage, ToPortalType } from 'Plugins/CommonUtils/Types/ToPortalMessages'
import { toPortalMessage, ToPortalType } from 'Plugins/CommonUtils/Types/ToPortalMessage'
// import { progressBarClosed } from 'Gadgets/LoginProgressBar'
// import { colorLogBg } from 'Functions/ColorConsole/ColorLogBg'

export const toPortal = () => ToPortalType.toRentCarMallPortal
...
export const extractReplyMessage =
  (successCall: InfoCallBackType, extraCall: ExtraCallBackType | null) =>
  (info: string) => {
