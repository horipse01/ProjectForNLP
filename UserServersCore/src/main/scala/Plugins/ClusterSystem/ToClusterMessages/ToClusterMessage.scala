...
@JsonSubTypes(
  Array(
    ...
    new JsonSubTypes.Type(value = classOf[ToHHShop4PortalMessage], name = "ToHHShop4PortalMessage"),
    ...
    new JsonSubTypes.Type(value = classOf[ToStudent2PortalMessage], name = "ToStudent2PortalMessage"),
    ...
    new JsonSubTypes.Type(value = classOf[ToStuLoginMessage], name = "ToStuLoginMessage"),
    ...
    new JsonSubTypes.Type(value = classOf[ToStudent3PortalMessage], name = "ToStudent3PortalMessage"),
    ...
    new JsonSubTypes.Type(value = classOf[ToStudent1PortalMessage], name = "ToStudent1PortalMessage"),
