...
object ServiceCenter {
  ...
  val hHShop4PortalServiceCode = "A000044"
  ...
  val student2PortalServiceCode = "A000047"
  ...
  val stuLoginServiceCode = "A000046"
  ...
  val student3PortalServiceCode = "A000048"
  ...
  val student1PortalServiceCode = "A000045"
  ...
  val fullNameMap: Map[String, String] = Map(
    ...
    hHShop4PortalServiceCode -> "HHShop4Portal",
    ...
    student2PortalServiceCode -> "Student2Portal",
    ...
    student3PortalServiceCode -> "Student3Portal",
    ...
    student1PortalServiceCode -> "Student1Portal",
  ...
  val portalPortMap: Map[String, Int] = Map(
    hHShop4PortalServiceCode -> 6000,
    student2PortalServiceCode -> 6001,
    hHShop2PortalServiceCode -> 6002,
    student3PortalServiceCode -> 6004,
    rentCarMallPortalServiceCode -> 6005,
    hHShop3PortalServiceCode -> 6006,
    mShopPortalServiceCode -> 6007,
    hHShopPortalServiceCode -> 6008,
    student1PortalServiceCode -> 6009,
    rentCarShopPortalServiceCode -> 6010,
    wShopPortalServiceCode -> 6011,
  )
