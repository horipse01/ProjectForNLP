...
abstract class ExceptionWithCode extends Exception{
  val code:String
  override def getMessage: String = GlobalVariables.serviceCode+getFullCode
...
case class WrongAPIFormatException() extends ExceptionWithCode{
  override val code: String = PluginsExceptionCode.commonUtilsExceptionCodePrefix +"07"
}
