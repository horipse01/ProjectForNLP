...
object ServiceCenter {
  ...
  val portalPortMap: Map[String, Int] = Map(
    ...
    hHShop2PortalServiceCode -> 6001,
    buyACarPortalServiceCode -> 6002,
    rentCarMallPortalServiceCode -> 6003,
    hHShop3PortalServiceCode -> 6004,
    mShopPortalServiceCode -> 6005,
    hHShopPortalServiceCode -> 6006,
    student1PortalServiceCode -> 6007,
    rentCarShopPortalServiceCode -> 6008,
    wShopPortalServiceCode -> 6009,
  )
